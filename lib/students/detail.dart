...
class _DetailsState extends State<Details> {
  Future accept() async {
    // 192.168.43.251
    // 192.168.43.251
    const url = 'http://192.168.43.132:8080/ocms/student/submit.php';
    var request = http.MultipartRequest('POST', Uri.parse(url));
    request.fields['reg_no'] = widget.reg_no.toString();
    request.fields['fromm'] = widget.fromm.toString();
    // request.fields['program_degree'] = widget.program_degree.toString();
  ...
  Widget _buildPopupDialog(BuildContext context) {
    ...
    Future decline() async {
      // 192.168.43.251
      // 192.168.43.251
      const url = 'http://192.168.43.132:8080/ocms/head_of_unit/decline.php';
      var request = http.MultipartRequest('POST', Uri.parse(url));
      ...
      request.fields['roles'] = widget.program_degree.toString();
      var response = await request.send();
