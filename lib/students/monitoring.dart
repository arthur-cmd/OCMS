...
import 'package:ocms/students/detail.dart';
...
class _MonitoringState extends State<Monitoring> {
  ...
  Future fetchData() async {
    ...
    const API_URL = 'http://192.168.43.132:8080/ocms/student/comments.php';
                                    ...
                                    Navigator.of(context)
                                        .push(MaterialPageRoute(
                                            builder: (context) => Details(
                                                  ...
                                                  program_degree: claims[index]
                                                      ['program_degree'],
                                                  reg_no: claims[index]
                                                      ['reg_no'],
                                                  comment: claims[index]
                                                      ['comment'],
                                                  roles: claims[index]['roles'],
                                                  fromm: claims[index]['fromm'],
                                                )));
                                  },
                                  child: Container(
                                    color: HexColor("#013221"),
