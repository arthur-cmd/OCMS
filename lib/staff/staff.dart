...
import 'package:ocms/staff/clearance.dart';
import 'package:ocms/staff/home.dart';
import 'package:ocms/staff/monitoring.dart';

class Staff extends StatefulWidget {
  const Staff(String text, {Key? key}) : super(key: key);
...
class _StaffState extends State<Staff> {
  int index = 1;
  final Screen = [Clearance(''), Home(), Monitoring()];
