...
import 'package:ocms/student_clearance/head_of_department/claims.dart';
import 'package:shared_preferences/shared_preferences.dart';
import 'package:http/http.dart' as http;

import '../../authentication/login.dart';

class Detailshod extends StatefulWidget {
  var names;
  var reg;
  var program;
  var hall;
  ...
  @override
  State<Detailshod> createState() => _DetailshodState();
}

class _DetailshodState extends State<Detailshod> {
  Future accept() async {
    const url = 'http://192.168.43.132:8080/ocms/student/send.php';
    var request = http.MultipartRequest('POST', Uri.parse(url));
    request.fields['name'] = widget.names.toString();
    ...
    try {
      if (response.statusCode == 200) {
        Navigator.pushReplacement(
            context, MaterialPageRoute(builder: (_) => Hod()));
  ...
  Widget _buildPopupDialog(BuildContext context) {
    ...
    Future decline() async {
      ...
      const url = 'http://192.168.43.132:8080/ocms/head_of_unit/hod_decline.php';
      var request = http.MultipartRequest('POST', Uri.parse(url));
