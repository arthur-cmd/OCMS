...
import 'package:ocms/student_clearance/usab/detail.dart';
import 'package:shared_preferences/shared_preferences.dart';

import '../../authentication/login.dart';
import '../warden/shimmer.dart';


class Usab extends StatefulWidget {
  const Usab({Key? key}) : super(key: key);

  @override
  _UsabState createState() => _UsabState();
}

class _UsabState extends State<Usab> {
  ...
  Future fetchData() async {
    ...
    const API_URL = 'http://192.168.43.132:8080/ocms/head_of_unit/usab.php';
      ...
      body: SingleChildScrollView(
        child: Column(
          children: [
           ...
           MaterialPageRoute(builder: (context) => Detailsu(hall: claims[index]['hall'], id: claims[index]['id'], names: claims[index]['names'], program: claims[index]['program_degree'], reg: claims[index]['reg_no'], room: claims[index]['room_no'], sponcer: claims[index]['sponcer'],)));
                              },
                              child: Container(
                                color: HexColor("#013221"),
                                height: 70,
