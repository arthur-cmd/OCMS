...
import 'package:ocms/student_clearance/bursar/detail.dart';
...
class Bursar extends StatefulWidget {
  const Bursar({Key? key}) : super(key: key);

  @override
  _BursarState createState() => _BursarState();
}

class _BursarState extends State<Bursar> {

  List claims = [];
  Future fetchData() async {
    http.Response response;
    const API_URL = 'http://192.168.43.132:8080/ocms/head_of_unit/bursar.php';
      ...
      body: SingleChildScrollView(
        child: Column(
          children: [
           ...
           MaterialPageRoute(builder: (context) => Detailsb(hall: claims[index]['hall'], id: claims[index]['id'], names: claims[index]['names'], program: claims[index]['program_degree'], reg: claims[index]['reg_no'], room: claims[index]['room_no'], sponcer: claims[index]['sponcer'],)));
                              },
                              child: Container(
                                color: HexColor("#013221"),
                                height: 70,
