...
import 'package:ocms/student_clearance/bursar/claims.dart';
...
class Detailsb extends StatefulWidget {
  ...
  @override
  State<Detailsb> createState() => _DetailsbState();
}

class _DetailsbState extends State<Detailsb> {
  Future accept() async {
    // 192.168.43.251
    // 192.168.43.251
    const url =
        'http://192.168.43.132:8080/ocms/head_of_unit/bursar_accept.php';
  ...
  Widget _buildPopupDialog(BuildContext context) {
    ...
    Future decline() async {
      ...
      var from = 'bursar';
      const url =
          'http://192.168.43.132:8080/ocms/head_of_unit/bursar_decline.php';
      var request = http.MultipartRequest('POST', Uri.parse(url));
      request.fields['names'] = widget.names.toString();
      request.fields['reg_no'] = widget.reg.toString();
      request.fields['program_degree'] = widget.program.toString();
