...
import 'package:ocms/student_clearance/smart_card/detail.dart';
import 'package:shared_preferences/shared_preferences.dart';

import '../../authentication/login.dart';
import '../dean/shimmer.dart';
...
class _SmartState extends State<Smart> {
  ...
  Future fetchData() async {
    ...
    const API_URL = 'http://192.168.43.132:8080/ocms/head_of_unit/smart_card.php';
      ...
      body: SingleChildScrollView(
        child: Column(
          children: [
           ...
           MaterialPageRoute(builder: (context) => Detailssm(hall: claims[index]['hall'], id: claims[index]['id'], names: claims[index]['names'], program: claims[index]['program_degree'], reg: claims[index]['reg_no'], room: claims[index]['room_no'], sponcer: claims[index]['sponcer'],)));
                              },
                              child: Container(
                                color: HexColor("#013221"),
                                height: 70,
