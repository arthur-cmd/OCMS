...
import 'package:ocms/staff_clearance/bursar_staff/head.dart';
...
class _DetailsState extends State<Details> {
  Future accept() async {
    // 192.168.43.251
    // 192.168.43.251
    const url = 'http://192.168.43.251/ocms/head_of_unit/accept.php';
  ...
  Widget _buildPopupDialog(BuildContext context) {
    ...
    Future decline() async {
      // 192.168.43.251
      // 192.168.43.251
      const url = 'http://192.168.43.251/ocms/head_of_unit/decline.php';
      var request = http.MultipartRequest('POST', Uri.parse(url));
      request.fields['names'] = widget.names.toString();
      request.fields['reg_no'] = widget.reg.toString();
      request.fields['program_degree'] = widget.program.toString();
      ...
      request.fields['roles'] = widget.program.toString();
      var response = await request.send();
