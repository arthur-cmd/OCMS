...
class Detailsl extends StatefulWidget {
  var names;
  var reg;
  var program;
  var hall;
  ...
  @override
  State<Detailsl> createState() => _DetailslState();
}

class _DetailslState extends State<Detailsl> {
  Future accept() async {
    // 192.168.43.251
    // 192.168.43.251
    const url = 'http://192.168.43.132:8080/ocms/head_of_unit/library_accept.php';
  ...
  Widget _buildPopupDialog(BuildContext context) {
    ...
    Future decline() async {
      ...
      // 192.168.43.251
      var from = 'library';
      const url = 'http://192.168.43.132:8080/ocms/head_of_unit/library_decline.php';
      var request = http.MultipartRequest('POST', Uri.parse(url));
      request.fields['names'] = widget.names.toString();
      request.fields['reg_no'] = widget.reg.toString();
      request.fields['program_degree'] = widget.program.toString();
