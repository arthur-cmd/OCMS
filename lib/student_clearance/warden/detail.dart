...
class Detailsh extends StatefulWidget {
  var names;
  var reg;
  var program;
  var hall;
  ...
  @override
  State<Detailsh> createState() => _DetailshState();
}

class _DetailshState extends State<Detailsh> {
  Future accept() async {
    // 192.168.43.251
    // 192.168.43.251
    const url = 'http://192.168.43.132:8080/ocms/head_of_unit/warden_accept.php';
  ...
  Widget _buildPopupDialog(BuildContext context) {
    ...
    Future decline() async {
      ...
      // 192.168.43.251
      var from = 'warden';
      const url = 'http://192.168.43.132:8080/ocms/head_of_unit/warden_decline.php';
      var request = http.MultipartRequest('POST', Uri.parse(url));
      request.fields['names'] = widget.names.toString();
      request.fields['reg_no'] = widget.reg.toString();
      request.fields['program_degree'] = widget.program.toString();
