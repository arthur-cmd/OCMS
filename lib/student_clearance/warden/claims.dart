...
import 'package:ocms/student_clearance/warden/detail.dart';
...
class _WardenState extends State<Warden> {
  ...
  Future fetchData() async {
    ...
    const API_URL = 'http://192.168.43.132:8080/ocms/head_of_unit/warden.php';
      ...
      body: SingleChildScrollView(
        child: Column(
          children: [
           ...
           MaterialPageRoute(builder: (context) => Detailsh(hall: claims[index]['hall'], id: claims[index]['id'], names: claims[index]['names'], program: claims[index]['program_degree'], reg: claims[index]['reg_no'], room: claims[index]['room_no'], sponcer: claims[index]['sponcer'],)));
                              },
                              child: Container(
                                color: HexColor("#013221"),
                                height: 70,
