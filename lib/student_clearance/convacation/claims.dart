...
import 'package:ocms/student_clearance/convacation/detail.dart';
...
class Convocation extends StatefulWidget {
  const Convocation({Key? key}) : super(key: key);
...
class _ConvocationState extends State<Convocation> {
  ...
  Future fetchData() async {
    ...
    const API_URL = 'http://192.168.43.132:8080/ocms/head_of_unit/convacation.php';
      ...
      body: SingleChildScrollView(
        child: Column(
          children: [
           ...
           MaterialPageRoute(builder: (context) => Detailsc(hall: claims[index]['hall'], id: claims[index]['id'], names: claims[index]['names'], program: claims[index]['program_degree'], reg: claims[index]['reg_no'], room: claims[index]['room_no'], sponcer: claims[index]['sponcer'],)));
                              },
                              child: Container(
                                color: HexColor("#013221"),
                                height: 70,
