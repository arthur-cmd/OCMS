...
import 'package:ocms/staff_clearance/secretary/detail.dart';
...
class Secretary extends StatefulWidget {
  const Secretary({Key? key}) : super(key: key);
...
class _SecretaryState extends State<Secretary> {
  ...
  Future fetchData() async {
    ...
    const API_URL = 'http://192.168.43.132:8080/ocms/head_of_unit_staff/secretary.php';
