...
class Detailr extends StatefulWidget {
  ...
  @override
  State<Detailr> createState() => _DetailrState();
}

class _DetailrState extends State<Detailr> {
  Future accept() async {
    // 192.168.43.251
    // 192.168.43.251
    const url =
        'http://192.168.43.132:8080/ocms/head_of_unit_staff/registry_accept.php';
  ...
  Widget _buildPopupDialog(BuildContext context) {
    ...
    Future decline() async {
      var from = 'Head of Registry';
      const url =
          'http://192.168.43.132:8080/ocms/head_of_unit_staff/registry_decline.php';
      var request = http.MultipartRequest('POST', Uri.parse(url));
      request.fields['names'] = widget.names.toString();
      request.fields['pay_roll'] = widget.pay_roll.toString();
