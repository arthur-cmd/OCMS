...
import 'package:ocms/staff_clearance/dvc/detail.dart';
import 'dart:convert';
...
class Dvc extends StatefulWidget {
  const Dvc({Key? key}) : super(key: key);

  @override
  _DvcState createState() => _DvcState();
}

class _DvcState extends State<Dvc> {
  List claims = [];
  Future fetchData() async {
    http.Response response;
    const API_URL = 'http://192.168.43.132:8080/ocms/head_of_unit_staff/dvc.php';
