...
class Detaildvc extends StatefulWidget {
  var names;
  var designation;
  var college;
  var pay_roll;
  ...
  @override
  State<Detaildvc> createState() => _DetaildvcState();
}

class _DetaildvcState extends State<Detaildvc> {
  Future accept() async {
    // 192.168.43.251
    // 192.168.43.251
    const url =
        'http://192.168.43.132:8080/ocms/head_of_unit_staff/dvc_accept.php';
  ...
  Widget _buildPopupDialog(BuildContext context) {
    ...
    Future decline() async {
      var from = 'Deputy Vice Chancelor';
      const url =
          'http://192.168.43.132:8080/ocms/head_of_unit_staff/dvc_decline.php';
      var request = http.MultipartRequest('POST', Uri.parse(url));
      request.fields['names'] = widget.names.toString();
      request.fields['pay_roll'] = widget.pay_roll.toString();
