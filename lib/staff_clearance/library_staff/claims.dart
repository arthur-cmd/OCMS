// ignore_for_file: curly_braces_in_flow_control_structures, prefer_const_constructors, constant_identifier_names, avoid_print, unnecessary_null_comparison, depend_on_referenced_packages, library_private_types_in_public_api, use_build_context_synchronously, camel_case_types, prefer_const_literals_to_create_immutables
...
import 'package:ocms/staff_clearance/library_staff/detail.dart';
import 'package:shared_preferences/shared_preferences.dart';

import '../../authentication/login.dart';
import '../sacoss/shimmer.dart';


class Library_staff extends StatefulWidget {
  const Library_staff({Key? key}) : super(key: key);

  @override
  _Library_staffState createState() => _Library_staffState();
}

class _Library_staffState extends State<Library_staff> {
  List claims = [];
  Future fetchData() async {
    http.Response response;
    const API_URL = 'http://192.168.43.132:8080/ocms/head_of_unit_staff/library_staff.php';
