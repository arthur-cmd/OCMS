...
class Detailh extends StatefulWidget {
  var names;
  var designation;
  var college;
  var pay_roll;
  ...
  @override
  State<Detailh> createState() => _DetailhState();
}

class _DetailhState extends State<Detailh> {
  Future accept() async {
    const url =
        'http://192.168.43.132:8080/ocms/head_of_unit_staff/health_accept.php';
  ...
  Widget _buildPopupDialog(BuildContext context) {
    ...
    Future decline() async {
      // 192.168.43.251
      // 192.168.43.251
      var from = 'NHIF MANAGER';
      const url =
          'http://192.168.43.251/ocms/head_of_unit_staff/health_decline.php';
      var request = http.MultipartRequest('POST', Uri.parse(url));
      request.fields['names'] = widget.names.toString();
      request.fields['pay_roll'] = widget.pay_roll.toString();
