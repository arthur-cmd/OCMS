...
import 'package:ocms/staff_clearance/coach_staff/detail.dart';
import 'package:shared_preferences/shared_preferences.dart';

import '../../authentication/login.dart';
import '../library_staff/shimmer.dart';

class Bursar_staff extends StatefulWidget {
  const Bursar_staff({Key? key}) : super(key: key);

  @override
  _Bursar_staffState createState() => _Bursar_staffState();
}

class _Bursar_staffState extends State<Bursar_staff> {
  List claims = [];
  Future fetchData() async {
    http.Response response;
    const API_URL =
        'http://192.168.43.132:8080/ocms/head_of_unit_staff/bursar.php';
