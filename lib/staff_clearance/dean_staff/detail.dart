...
class _DetailsdState extends State<Detailsd> {
  Future accept() async {
    ...
    // 192.168.43.251
    const url =
        'http://192.168.43.132:8080/ocms/head_of_unit_staff/dean_staff_accept.php';
  ...
  Widget _buildPopupDialog(BuildContext context) {
    ...
    Future decline() async {
      // 192.168.43.251
      // 192.168.43.251
      var from = 'Dean of college';
      const url =
          'http://192.168.43.132:8080/ocms/head_of_unit_staff/dean_staff_decline.php';
      var request = http.MultipartRequest('POST', Uri.parse(url));
      request.fields['names'] = widget.names.toString();
      request.fields['pay_roll'] = widget.pay_roll.toString();
