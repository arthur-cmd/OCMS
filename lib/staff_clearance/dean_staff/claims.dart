...
import 'package:ocms/staff_clearance/dean_staff/detail.dart';
import 'package:shared_preferences/shared_preferences.dart';

import '../../authentication/login.dart';
import '../library_staff/shimmer.dart';

class Dean_staff extends StatefulWidget {
  const Dean_staff({Key? key}) : super(key: key);

  @override
  _Dean_staffState createState() => _Dean_staffState();
}

class _Dean_staffState extends State<Dean_staff> {
  List claims = [];
  Future fetchData() async {
    ...
    const API_URL =
        'http://192.168.43.132:8080/ocms/head_of_unit_staff/dean_staff.php';
