...
class Detailsss extends StatefulWidget {
  ...
  @override
  State<Detailsss> createState() => _DetailsssState();
}
...
class _DetailsssState extends State<Detailsss> {
  Future accept() async {
    ...
    // 192.168.43.251
    const url =
        'http://192.168.43.132:8080/ocms/head_of_unit_staff/saccoss_accept.php';
  ...
  Widget _buildPopupDialog(BuildContext context) {
    ...
    Future decline() async {
      ...
      var from = 'saccoss';
      const url =
          'http://192.168.43.251/ocms/head_of_unit_staff/saccoss_decline.php';
      var request = http.MultipartRequest('POST', Uri.parse(url));
      request.fields['names'] = widget.names.toString();
      request.fields['pay_roll'] = widget.pay_roll.toString();
