...
class Detailses extends StatefulWidget {
  var names;
  var designation;
  var college;
  var pay_roll;
  ...
  @override
  State<Detailses> createState() => _DetailsesState();
}

class _DetailsesState extends State<Detailses> {
  Future accept() async {
    const url =
        'http://192.168.43.132:8080/ocms/head_of_unit_staff/estate_accept.php';
  ...
  Widget _buildPopupDialog(BuildContext context) {
    ...
    Future decline() async {
      // 192.168.43.251
      // 192.168.43.251
      var from = 'ESTATE MANAGER';
      const url =
          'http://192.168.43.132:8080/ocms/head_of_unit_staff/estate_decline.php';
      var request = http.MultipartRequest('POST', Uri.parse(url));
      request.fields['names'] = widget.names.toString();
      request.fields['pay_roll'] = widget.pay_roll.toString();
