...
import 'package:ocms/staff_clearance/hods/detail.dart';
import 'package:shared_preferences/shared_preferences.dart';

import '../../authentication/login.dart';
import '../estate/shimmer.dart';


class Hods extends StatefulWidget {
  const Hods({Key? key}) : super(key: key);

  @override
  _HodsState createState() => _HodsState();
}
...
class _HodsState extends State<Hods> {
  ...
  Future fetchData() async {
    ...
    const API_URL = 'http://192.168.43.132:8080/ocms/head_of_unit_staff/hods.php';
